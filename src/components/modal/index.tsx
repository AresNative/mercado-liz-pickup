            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.section
                        ...
                        className={cn(
                            "fixed z-50 inset-0 h-screen md:h-fit md:max-h-[90dvh] mx-auto overflow-auto md:w-11/12 md:my-4 md:rounded-lg bg-[var(--background)] text-left shadow-xl",
                    ...
                    >
                        ...
                        {/* Contenido */}
                        <main className="p-4 m-auto bg-white">{children}</main>
                    </motion.section>
                )}
            </AnimatePresence>
        </dialog>
