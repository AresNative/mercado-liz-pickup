    ...
    return (
        <div className="flex flex-col">
            ...
            <div className="relative flex gap-2">
                <select
                    name="countryCode"
                    className="bg-white dark:bg-zinc-800 px-2 py-2 border focus:ring-purple-500 focus:border-purple-900 sm:text-sm border-gray-300  dark:border-zinc-700 rounded-md focus:outline-none text-gray-600 dark:text-gray-100 [&:-webkit-autofill]:bg-white [&:-webkit-autofill]:text-gray-600 [&:-webkit-autofill]:dark:bg-zinc-800 [&:-webkit-autofill]:dark:text-white [&:-webkit-autofill]:transition-colors [&:-webkit-autofill]:duration-[999999s]"
                    defaultValue="+52"
                >
                ...
                <input
                    ...
                    className="bg-white dark:bg-zinc-800 px-4 py-2 border focus:ring-purple-500 focus:border-purple-900 w-full sm:text-sm border-gray-300  dark:border-zinc-700 rounded-md focus:outline-none text-gray-600 dark:text-gray-100
